  ...
  return (
    <main className="flex flex-col items-center justify-between p-4 body">
      ...
      <div className="preWrap w-[1000px]">
        <p>
          Hello world, welcome to my personal website! My name is Chris &ldquo;Maddie&rdquo; Wong (She/Her). I am from Malaysia born in Kota Kinabalu, Sabah.
      ...
      <div className="mt-[10px] mediums flex">
        <Link href="https://github.com/maddiew95">
